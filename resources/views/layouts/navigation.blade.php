<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 shadow-md fixed w-full z-[12]">
    ...
    <div class="w-full flex bg-white px-8 fixed-top border-t border-gray-200">
        @if(auth()->user()->is_admin)
            ...
            <a href="javascript:;" class="font-semibold hover:bg-gray-100 py-3 px-2 @if(str_contains(Route::currentRouteName(), 'mappings')) bg-gray-100 text-[#0085CA] @endif"><i class="fal fa-list mr-1"></i> Produkte</a>
        @endif

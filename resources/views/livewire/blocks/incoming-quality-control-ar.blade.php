        ...
        <div class="w-full h-max flex flex-col bg-white border-r border-gray-200 px-8 pt-3 pb-4" x-show="!hidePanel">
            ...
            <div class="flex flex-col h-full relative gap-2 mt-3" x-data="{ operator: {{ auth()->user()->personnel_number }}, rejection: @entangle('selectedRejection').defer }">
                ...
                <div class="flex flex-col relative z-[6]" x-data="{ serialsOpen: false }">
                    ...
                    <input wire:model="serial" onfocus="this.setSelectionRange(0, this.value.length)" @focus="serialsOpen = true" @focusout="serialsOpen = false" type="text" class="bg-gray-100 @error('serial') border-1 border-red-500/40 rounded-t-sm @else border-0 rounded-sm @enderror text-sm font-semibold" tabindex="2" placeholder="Serial eingeben oder scannen..."/>

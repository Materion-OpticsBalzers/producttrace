<div class="bg-white w-full h-full max-w-xs min-w-xs z-[10] overflow-y-auto" x-data="{ openInfo: false }">
    ...
    <div class="flex flex-col divide-y divide-gray-200 h-full" x-show="!openInfo">

<div class="h-full w-full flex flex-col justify-center items-center max-w-md mx-auto" x-data="{ order: '' }">
    ...
    <div class="flex flex-col bg-white w-full divide-y mt-2 divide-gray-200 shadow-md border border-gray-200 h-48 overflow-y-auto">
        <div class="text-xs sticky top-0 bg-white border-b border-gray-200 text-gray-500 px-2 py-0.5">{{ $orders->count() }} neuste Aufträge</div>
